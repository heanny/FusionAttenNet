...
class AblationAnalysis:
    ...
    def setup_paths(self):
        ...
        self.plots_dir = Path('vis_clau_ablation_study_lh')
    ...
    def _plot_spatial_attention_comparison_full(self, baseline_maps, no_feature_maps):
        ...
        axes[0].set_title('FusionAttenNet: Spatial Attention(Left-semi Brain)')
        
        # Plot no_feature_attention
        im2 = axes[1].imshow(mean_no_feature, cmap='hot', vmin=vmin, vmax=vmax)
        axes[1].set_title('No-Feature-Attention model: Spatial Attention (Left-semi Brain)')
    ...
    def _plot_channel_attention_comparison(self):
        ...
        ax.set_title('Channel Attention Weights Comparison (Left-semi Brain)')
        ax.set_xticks(x)
    ...
    def _plot_feature_attention_comparison(self):
        ...
        ax.set_title('Feature Attention Weights Comparison (Left-semi Brain)')
        ax.set_xticks(x)
        ax.set_xticklabels(features)
        ax.legend()
...
# %%
    ...
    def _plot_attention_statistics_comparison(self):
        ...
        ax.set_title('Spatial Attention Statistics per Cortical Feature (Left-semi Brain)')
        ax.set_xticks(x)
        ax.set_xticklabels(features)
        ax.legend()
    ...
    # 2. Channel Attention Analysis
        ...
        ax.set_title('Channel Attention Statistics per Cortical Feature (Left-semi Brain)')
        ax.set_xticks(x)
        ax.set_xticklabels(features)
        ax.legend()
       ...
       # 3. Feature Attention Analysis
        ...
        ax.set_title('Feature Attention Statistics per Cortical Feature (Left-semi Brain)')
        ax.set_xticks(x)
        ax.set_xticklabels(features)
        ax.legend()
...
# %%
    ...
    def analyze_phenotype_feature_weights(self):
        ...
        ax.set_ylabel('Feature Attention Weight')
        ax.set_title('Phenotype Feature Attention Weights (Left-semi Brain)')
        ax.set_xticks(x)
    ...
    def analyze_task_specific_weights(self):
        ...
        ax1.set_title('Feature Weights in Attention Prediction (Left-semi Brain)')
    ...
    # 在箱线图上添加中位数标签
        ...
        ax2.set_title('Feature Weights in Age Prediction (Left-semi Brain)')
    ...
    # 在箱线图上添加中位数标签
        ...
        # 打印分组统计信息
        print("\nAttention Task Weight Statistics (Left-semi Brain) with medians:")
        print(pd.DataFrame(attention_weights, columns=phenotype_features).describe())
        print("\nAge Task Weight Statistics (Left-semi Brain):")
    ...
    def _plot_error_analysis(self):
        ...
        axes[0, 0].set_title('Age Prediction - Error Statistics (Left-semi Brain)')
        ...
        axes[0, 1].set_title('Age Prediction - High Error Distribution (Left-semi Brain)')
        ...
        axes[1, 0].set_title('Attention Prediction - Error Statistics (Left-semi Brain)')
        ...
        axes[1, 1].set_title('Attention Prediction - High Error Distribution (Left-semi Brain)')
...
if __name__ == "__main__":
    base_dir = '/home/jouyang1/ablation_study_lh_results_20250207_172701/ablation_study_20250207_172702'
