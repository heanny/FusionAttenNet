...
if __name__ == "__main__":
    ...
    output_dir = f'ablation_study_rh_results_{timestamp}'

    
    # 指定baseline模型路径
    full_model_path = '/home/jouyang1/training_all_data_rh_mirror_attmap_20250205_041248/models/all_rh_best_model.pth'
