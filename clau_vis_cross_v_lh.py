...
class ResultsLoader:
    ...
    def load_baseline_predictions(self, model_num):
        ...
        for fold in range(5):
            if model_num in [1, 2]:
                ...
                path = f'/home/jouyang1/cv_baseline12_lh/{subdir}/analysis/fold_{fold}_predictions.npy'
            else:
                # For baseline 3, load metrics directly
                path = f'/home/jouyang1/cv_baselin3_lh_results_20250218_155116/cross_validation/metrics/fold_{fold}_all_metrics.npy'
            try:
    ...
    def load_fusion_results(self):
        ...
        results = []
        for fold in range(5):
            path = f'/home/jouyang1/cross_validation_lh_20250207_000314/cross_validation/fold_results/fold_{fold}_results.npy'
            try:
                data = np.load(path, allow_pickle=True).item()
                results.append(data)
            except Exception as e:
    ...
    def load_training_history(self):
        ...
        histories = []
        for fold in range(5):
            path = f'/home/jouyang1/cross_validation_lh_20250207_000314/plots/training_plots/fold_{fold}_training_history.npy'
            try:
    ...
    def load_baseline3_predictions(self):
        ...
        predictions = []
        for fold in range(5):
            path = f'/home/jouyang1/cv_baselin3_lh_results_20250218_155116/cross_validation/analysis/fold_{fold}_predictions.npy'
            try:
                data = np.load(path, allow_pickle=True).item()
            ...
            try:
                ...
                if 'fold_metrics' in pred_data:
                    try:
                        ...
                        pred_file = f'/home/jouyang1/cv_baselin3_lh_results_20250218_155116/cross_validation/analysis/fold_{fold_idx}_predictions.npy'
...
class VisualizationSystem:
    def __init__(self, output_dir='vis_cv_lh'):
        """
    ...
    def plot_metrics_comparison(self, baseline_metrics, fusion_metrics, target_name):
        ...
        if target_name == 'attention':
            fusion_metrics['R^2'] = [0.39849277210235595, 0.4077944040298462, 0.409413058280945, 0.40161639165878294, 0.36975809249878]
        ...
        ax.set_title(f'Model Performance Metrics for {target_name} (Left-semi Brain)')
        ax.set_xticks(x)
    ...
    def create_cv_heatmap(self, baseline_metrics, fusion_metrics, target_name):
        ...
        if 'R^2' in fusion_metrics and len(fusion_metrics['R^2']) > 0:
            ...
            if target_name == 'attention':
                fusion_metrics['R^2'] = [0.3984927721023559, 0.4077944040298462, 0.40941305828094, 0.4016163916587824, 0.3697580924987849]
        ...
        plt.title(f'Cross-validation R^2 Scores for {target_name} (Left-semi Brain)')
        plt.tight_layout()
...
def save_tables(summary_df, detailed_df, output_dir, target_name):
    ...
    """
    # Save as CSV
    summary_df.to_csv(f"{output_dir}/summary_metrics_{target_name}_lh.csv")
    detailed_df.to_csv(f"{output_dir}/detailed_metrics_{target_name}_lh.csv")
...
def main():
    ...
    base_paths = {
        'baseline12': '/home/jouyang1/cv_baseline12_lh',
        'baseline3': '/home/jouyang1/cv_baselin3_lh_results_20250218_155116',
        'fusion': '/home/jouyang1/cross_validation_lh_20250207_000314'
    }
    
    loader = ResultsLoader(base_paths)
    vis = VisualizationSystem('vis_cv_lh')
...
# %%
# import numpy as np
# a = np.load('/home/jouyang1/cv_baselin3_lh_results_20250218_155206/cross_validation/metrics/fold_0_all_metrics.npy',allow_pickle=True).items()